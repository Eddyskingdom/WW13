...
/material/proc/generate_recipes()
	...
	if (hardness>50)
		...
		recipes += new/datum/stack_recipe("makeshift knife blade", /obj/item/weapon/material/makeshift_knife_blade, _time = 10, TRUE, _on_floor = TRUE, _supplied_material = "[name]")
...
/material/wood/generate_recipes()
	...
	recipes += new/datum/stack_recipe("makeshift knife grip", /obj/item/weapon/material/makeshift_knife_grip, _time = 10, TRUE, _on_floor = TRUE, _supplied_material = "[name]")
