...
/obj/item/weapon/reagent_containers/food/drinks/bottle/gin/empty_gin
	name = "Griffeater Gin"
	desc = "A bottle of high quality gin, produced in the New London Station. it's empty"
	icon_state = "ginbottle"
	center_of_mass = list("x"=16, "y"=4)
	New()
		..()
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/whiskey/empty_whiskey
	name = "Uncle Git's Special Reserve"
	desc = "A premium single-malt whiskey, gently matured inside the tunnels of a nuclear shelter. TUNNEL WHISKEY RULES. it's empty"
	icon_state = "whiskeybottle"
	center_of_mass = list("x"=16, "y"=3)
	New()
		..()
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/vodka/empty_vodka
	name = "Tunguska Triple Distilled"
	desc = "Aah, vodka. Prime choice of drink AND fuel by Russians worldwide.it's empty"
	icon_state = "vodkabottle"
	center_of_mass = list("x"=17, "y"=3)
	New()
		..()
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/tequilla/empty_tequilla
	name = "Caccavo Guaranteed Quality Tequilla"
	desc = "Made from premium petroleum distillates, pure thalidomide and other fine quality ingredients! it's empty"
	icon_state = "tequillabottle"
	center_of_mass = list("x"=16, "y"=3)
	New()
		..()
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/patron/empty_patron
	name = "Wrapp Artiste Patron"
	desc = "Silver laced tequilla, served in night clubs across the earth. it's empty"
	icon_state = "patronbottle"
	center_of_mass = list("x"=16, "y"=6)
	New()
		..()
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/rum/empty_rum
	name = "Captain Pete's Cuban Spiced Rum"
	desc = "This isn't just rum, oh no. It's practically GRIFF in a bottle. it's empty"
	icon_state = "rumbottle"
	center_of_mass = list("x"=16, "y"=8)
	New()
		..()
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/vermouth/empty_vermouth
	name = "Goldeneye Vermouth"
	desc = "Sweet, sweet dryness~ it's empty"
	icon_state = "vermouthbottle"
	center_of_mass = list("x"=17, "y"=3)
	New()
		..()
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/kahlua/empty_kahlua
	name = "Robert Robust's Coffee Liqueur"
	desc = "A widely known, Mexican coffee-flavoured liqueur. In production since 1936, HONK. it's empty"
	icon_state = "kahluabottle"
	center_of_mass = list("x"=17, "y"=3)
	New()
		..()
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/goldschlager/empty_goldschlager
	name = "College Girl Goldschlager"
	desc = "Because they are the only ones who will drink 100 proof cinnamon schnapps. it's empty"
	icon_state = "goldschlagerbottle"
	center_of_mass = list("x"=15, "y"=3)
	New()
		..()
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/cognac/empty_cognac
	name = "Chateau De Baton Premium Cognac"
	desc = "A sweet and strongly alchoholic drink, made after numerous distillations and years of maturing. You might as well not scream 'SHITCURITY' this time. it's empty"
	icon_state = "cognacbottle"
	center_of_mass = list("x"=16, "y"=6)
	New()
		..()
		reagents.add_reagent("cognac", 0)
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/wine/empty_wine
	name = "Doublebeard Bearded Special Wine"
	desc = "A faint aura of unease and asspainery surrounds the bottle. it's empty"
	icon_state = "winebottle"
	center_of_mass = list("x"=16, "y"=4)
	New()
		..()
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/absinthe/empty_asbinthe
	name = "Jailbreaker Verte"
	desc = "One sip of this and you just know you're gonna have a good time.it's empty"
	icon_state = "absinthebottle"
	center_of_mass = list("x"=16, "y"=6)
	New()
		..()
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/melonliquor/empty_melonliquor
	name = "Emeraldine Melon Liquor"
	desc = "A bottle of 46 proof Emeraldine Melon Liquor. Sweet and light. it's empty"
	icon_state = "alco-green" //Placeholder.
	center_of_mass = list("x"=16, "y"=6)
	New()
		..()
		reagents.add_reagent("melonliquor", 0)
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/bluecuracao/empty_bluecuracao
	name = "Miss Blue Curacao"
	desc = "A fruity, exceptionally azure drink. Does not allow the imbiber to use the fifth magic.it's empty"
	icon_state = "alco-blue" //Placeholder.
	center_of_mass = list("x"=16, "y"=6)
	New()
		..()
		reagents.add_reagent("bluecuracao", 0)
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/grenadine/empty_grenadine
	name = "Briar Rose Grenadine Syrup"
	desc = "Sweet and tangy, a bar syrup used to add color or flavor to drinks. it's empty"
	icon_state = "grenadinebottle"
	center_of_mass = list("x"=16, "y"=6)
	New()
		..()
		reagents.add_reagent("grenadine", 0)

/obj/item/weapon/reagent_containers/food/drinks/bottle/cola
	name = "\improper Cola"
	desc = "Cola a sugery drink with a nice pop"
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/cola/empty_cola
	name = "\improper Cola"
	desc = "Cola a sugery drink with a nice pop. it's empty"
	icon_state = "colabottle"
	center_of_mass = list("x"=16, "y"=6)
	New()
		..()
		reagents.add_reagent("cola", 0)
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/orangejuice/empty_orangejuice
	name = "Orange Juice"
	desc = "Full of vitamins and deliciousness! it's empty"
	icon_state = "orangejuice"
	item_state = "carton"
	center_of_mass = list("x"=16, "y"=7)
	isGlass = FALSE
	New()
		..()
		reagents.add_reagent("orangejuice", 0)
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/cream/empty_cream
	name = "Milk Cream"
	desc = "It's cream. Made from milk. What else did you think you'd find in there? it's empty"
	icon_state = "cream"
	item_state = "carton"
	center_of_mass = list("x"=16, "y"=8)
	isGlass = FALSE
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/tomatojuice/empty_tomatojuice
	name = "Tomato Juice"
	desc = "Well, at least it LOOKS like tomato juice. You can't tell with all that redness. it's empty"
	icon_state = "tomatojuice"
	item_state = "carton"
	center_of_mass = list("x"=16, "y"=8)
	isGlass = FALSE
	New()
		..()
		reagents.add_reagent("tomatojuice", 0)
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/limejuice/empty_limejuice
	name = "Lime Juice"
	desc = "Sweet-sour goodness. it's empty"
	icon_state = "limejuice"
	item_state = "carton"
	center_of_mass = list("x"=16, "y"=8)
	isGlass = FALSE
	New()
		..()
		reagents.add_reagent("limejuice", 0)
